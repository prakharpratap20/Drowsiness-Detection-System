...
def generator(dir,
    ...
    """
    Takes the path to a directory, and generates batches of augmented image data.
    """
...
model.compile(optimizer='adam', loss='categorical_crossentropy',
              # categorical_crossentropy if multi-class classifier
              metrics=['accuracy'])

model.fit_generator(train_batch, validation_data=valid_batch,
                    # more steps per epoch for better accuracy
